...
export class PaginationComponent implements OnInit {
 ...
 /*  sortdata()
  ...
  console.log("sorted", sorted);
   ...
   verify(centerId){
     this._paginationService.Verify(centerId).subscribe(res => {
       if(res){
       //  this.toastr.success('Successfully verfied','success',{timeOut: 3000});
         console.log("succcessfully verify")
       }
       else{
       //  this.toastr.error('problem to verify');
        console.log("problem to verify")
       }
     })
   }
